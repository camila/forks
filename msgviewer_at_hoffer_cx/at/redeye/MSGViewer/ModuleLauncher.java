...
{       
    ...
    public ModuleLauncher( String[] args )
    {
        ...
        root = new LocalRoot("MSGViewer", "MSGViewer", false, true);
        ...
        root.setLanguageTranslationResourcePath("/at/redeye/MSGViewer/resources/translations");
    }
	...
	FrameWorkConfigDefinitions.registerDefinitions();
        ...
        root.registerPlugin(new at.redeye.MSGViewer.Plugins.msgparser.Plugin());
        root.registerPlugin(new at.redeye.MSGViewer.Plugins.tnef.Plugin());
        root.registerPlugin(new at.redeye.MSGViewer.Plugins.poi.Plugin());
        root.registerPlugin(new at.redeye.MSGViewer.Plugins.javamail.Plugin());
        ...
        if( getStartupFlag("-nocreatedesktopicon") ){
            mainwin.disableCreateDesktopIcon();
        }
